    ...
    return (
      <div className="container-fluid" id="examples">
        ...
        <div className="stories">
          ...
          <div className="photo">
            <img src="https://exposure.imgix.net/production/posts/168603/cover-photo/cover-1460539503.jpg?w=500&h=500&q=58&fm=pjpg&auto=format&sharp=4&crop=&fit=crop" alt="Belize" />
          ...
          <div className="photo">
            <img src="https://exposure.imgix.net/production/posts/50421/cover-photo/cover-1405074651.jpg?w=1500&h=900&q=58&fm=pjpg&auto=format&sharp=4&crop=&fit=crop" alt="The Large Hadron Collider" />
