    ...
    return (
      <div className="container-fluid" id="examples">
        ...
        <div className="stories">
          <div className="photo">
            <Link to="/the-real-steel" className="page"><img src="https://exposure.imgix.net/production/posts/183018/cover-photo/cover-1466125923.jpg?w=500&h=500&q=58&fm=pjpg&auto=format&sharp=4&crop=&fit=crop" alt="The Real Steel"/></Link>
          ...
          <div className="photo">
            <Link to="/belize" className="page"><img src="https://exposure.imgix.net/production/posts/168603/cover-photo/cover-1460539503.jpg?w=500&h=500&q=58&fm=pjpg&auto=format&sharp=4&crop=&fit=crop" alt="Belize" /></Link>
          ...
          <div className="photo">
            <Link to="/the-large-hadron-collider" className="page"><img src="https://exposure.imgix.net/production/posts/50421/cover-photo/cover-1405074651.jpg?w=1500&h=900&q=58&fm=pjpg&auto=format&sharp=4&crop=&fit=crop" alt="The Large Hadron Collider" /></Link>
